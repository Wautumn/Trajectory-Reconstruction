...
class PoswiseFeedForwardNet(pl.LightningModule):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(d_model, d_ff).cuda()
        self.fc2 = nn.Linear(d_ff, d_model).cuda()
...
class Model(pl.LightningModule):
    def __init__(self, vocab_size, id2embed):
        ...
        self.model = BERT(vocab_size=vocab_size, id2embed=id2embed).cuda()
